...
- [x] Add inspect-ttc command: list all fonts in a TTC with names/metrics
- [x] Add --list flag to ttc2ttf: show font names without extracting
- [x] OTC/CFF support: detect OTTO SFNTVersion, use .otf extension
- [x] Native TTC support in fontmetrics via opentype.ParseCollection
- [x] Lint, test, commit, push
